...
DeclareAttribute("UniversalGradingData", IsFusionRing);
DeclareOperation("UniversalGradingComponent", [ IsFusionRing, IsObject ]);
DeclareAttribute("UniversalGradingOrder", IsFusionRing);
